        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                <div class="card-body top-card-content">
                    <div class="id-body">
                        <a href="/terorero/badges/65-Badge-5b8010ca59441/" class="">
                            Цена		</a>
                    </div>
                    <div class="price-body">
                        <a href="/terorero/badges/65-Badge-5b8010ca59441/" class="">
                            <!--<strike>1,99 лв.</strike>-->
                            11,50 лв.												</a>
                    </div>
                </div>
                <div class="badge-img">
                    <a href="#" class="">
                        <img class="card-img-top img-fluid" src="../../../assets/img/tahan720.png" alt="">
                    </a>
                </div>
                ...
                <div class="card-body holder-add-to-cart">
                    <div class="card-btn-holder">
                        <a class="btn medium-button" data-badge-add-to-cart="" href="javascript:;">
