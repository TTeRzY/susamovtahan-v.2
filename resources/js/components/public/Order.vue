            ...
            <div class="card" v-for="(item, index) in products">
                ...
                <div class="card-body holder-add-to-cart">
                    <div class="card-btn-holder">
                        <a class="btn medium-button" data-badge-add-to-cart="" href="#"
                           @click.prevent="addToCart(item, index)">
                            <svg data-v-332fccf4="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.854 22.917">
                                <g data-v-332fccf4="" id="Group_1132" data-name="Group 1132"
                                   transform="translate(-2725 -529)">
                                    <g data-v-332fccf4="" id="Group_956" data-name="Group 956"
                                       transform="translate(2725 529)">
                                        <path data-v-332fccf4="" id="Path_228" data-name="Path 228"
                                              ...
                                              transform="translate(0 -10.893)" class="cls-1"></path>
                                    </g>
                                </g>
                            </svg>
