            ...
            <form name="sesame_oil_form" enctype="multipart/form-data" method="POST" action="{{ route('sesame_oil.store') }}" class="col-md-12 home-form">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <input name="sesame_oil_image" id="sesame_oil_image" type="file" class="form-control-file validate">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="sesame_oil_title">Име</label>
                        <input name="sesame_oil_title" id="sesame_oil_title" type="text" class="form-control validate">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="sesame_oil_price">Цена</label>
                        <input name="sesame_oil_price" id="sesame_oil_price" type="text" class="form-control validate">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="sesame_oil_info">Информация</label>
                        <input name="sesame_oil_info" id="sesame_oil_info" type="text" class="form-control validate">
                    </div>
                    <div class="form-group col-lg-12">
                        <label for="sesame_oil_more_info">Повече информация за продукта</label>
                        <textarea name="sesame_oil_more_info" id="sesame_oil_more_info" type="text" class="form-control validate">
                        </textarea>
                    </div>
                </div>
